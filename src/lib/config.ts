...
export const COURSE_LIVE = {
  ...
  cashLabel: "R$ 3.000,00 no Pix",
  planLabel: "R$ 3.000 no Pix à vista ou em até 10× no cartão com juros",
  installments: 10,
  installmentValue: 0,
  entryFee: 0,
  entryLabel: "",
  totalLabel: "até 10× no cartão",
  cardMaxInstallments: 10,
  cardInterestMonthly: 0.0199,
  cardInterestLabel: "1,99% a.m.",
  includes: [
